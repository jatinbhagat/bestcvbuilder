...
try:
    ...
    CV_OPTIMIZATION_TEMPLATE = prompt_templates.CV_OPTIMIZATION_TEMPLATE
    PROFESSIONAL_SUMMARY_TEMPLATE = prompt_templates.PROFESSIONAL_SUMMARY_TEMPLATE
    EXPERIENCE_OPTIMIZATION_TEMPLATE = prompt_templates.EXPERIENCE_OPTIMIZATION_TEMPLATE
    SKILLS_ENHANCEMENT_TEMPLATE = prompt_templates.SKILLS_ENHANCEMENT_TEMPLATE
    ACHIEVEMENT_QUANTIFICATION_TEMPLATE = prompt_templates.ACHIEVEMENT_QUANTIFICATION_TEMPLATE
    KEYWORD_INTEGRATION_TEMPLATE = prompt_templates.KEYWORD_INTEGRATION_TEMPLATE
